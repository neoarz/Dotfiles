...
vim.api.nvim_set_hl(0, "NormalNC", { bg = "none" }) -- Make non-current window background transparent
-- Set Treesitter highlights with transparent and darker background

-- Set transparency blur for Neovim UI (may depend on terminal capabilities)
vim.cmd [[
